...
import com.test.dynamic.presenter.MyAddressAtPresenter;
...
import com.test.dynamic.ui.view.IMyAddressAtView;
...
public class MyAddressActivity extends BaseActivity<IMyAddressAtView,MyAddressAtPresenter> implements IMyAddressAtView,ViewPager.OnPageChangeListener{
    @Bind(R.id.vp_record)
    ViewPager vp_record;
    ...
    public void initData() {
        ...
        fragmentList.add(FragmentFactory.getInstance().getRecAddressFragment());
        fragmentList.add(FragmentFactory.getInstance().getSendAddressFragment());
...
//            upLoadDataFragment.initFragmentData();
    ...
    @Override
    protected MyAddressAtPresenter createPresenter() {
        return new MyAddressAtPresenter(this);
    }
