...
import com.test.dynamic.presenter.MyPacketAtPresenter;
...
import com.test.dynamic.ui.view.IMyPacketAtView;
...
public class MyPacketActivity extends BaseActivity<IMyPacketAtView,MyPacketAtPresenter> implements IMyPacketAtView,ViewPager.OnPageChangeListener{
    @Bind(R.id.vp_record)
    ViewPager vp_record;
    ...
    public void initData() {
        ...
        fragmentList.add(FragmentFactory.getInstance().getYesRecPacketFragment());
        fragmentList.add(FragmentFactory.getInstance().getNoRecPacketFragment());
    ...
    @Override
    protected MyPacketAtPresenter createPresenter() {
        return new MyPacketAtPresenter(this);
    }
