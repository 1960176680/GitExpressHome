...
import com.test.dynamic.util.country.address.GetJsonDataUtil;
import com.test.dynamic.util.country.address.JsonBean;
...
public class NewAddressAtPresenter extends BasePresenter<INewAddressAtView> {
    ...
    public NewAddressAtPresenter(BaseActivity context) {
        super(context);
    }
    ...
    private void ShowPickerView() {// 弹出选择器
        ...
        OptionsPickerView pvOptions = new OptionsPickerView.Builder(mContext, (options1, options2, options3, v) -> {
            ...
            getView().getSelectAddr().setText(tx);
